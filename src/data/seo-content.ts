...
export const pillarPage: SEOArticle = {
  ...
  metaDescription:
    'Alles over het slow carb dieet van Tim Ferriss. 5 regels, geen calorieën tellen, 1 cheatday per week. Inclusief recepten en weekplanning.',
  author: 'Jesper',
  readingTime: '12 min',
  ...
  sections: [
    {
      ...
      content: `
        ...
        <p>In de praktijk verliezen de meeste mensen 4 tot 8 kilo in de eerste zes weken. Zonder honger, zonder sportschool, zonder de constante twijfel of je het "goed doet".</p>
      `,
    },
    {
      ...
      subsections: [
        {
          ...
          content: `
            ...
            <p>Wat mag er wél? Peulvruchten (linzen, kidneybonen, kikkererwten), groenten, eieren, vis en vlees. Deze voedingsmiddelen verteren langzaam — vandaar "slow carb" — en houden je uren vol.</p>
    ...
    },
    {
      ...
      subsections: [
        ...
        },
        {
          ...
          content: `
            <p>Calorieën tellen werkt. Maar het probleem is compliance: de meeste mensen houden het geen zes weken vol. Elke maaltijd wegen, loggen, berekenen — het kost cognitieve energie die je niet hebt als je een druk leven leidt.</p>
    ...
    },
    {
      ...
      content: `
        <p>De resultaten variëren per persoon, maar dit zijn realistische verwachtingen:</p>
        <ul>
          ...
          <li><strong>Totaal na 6 weken:</strong> 4-8 kilo is realistisch</li>
        </ul>
        <p>Sommige mensen verliezen meer. Hoe meer overgewicht je hebt, hoe sneller de eerste kilo's eraf gaan. Jesper — oprichter van SlowCarb en ex-militair — verloor 8 kilo in zes weken, startend op 111 kilo.</p>
...
export const ketoComparisonArticle: SEOArticle = {
  ...
  metaDescription:
    'Eerlijke vergelijking tussen slow carb en keto. Welk dieet is makkelijker vol te houden? Zonder hype, met feiten.',
  author: 'Jesper',
  readingTime: '8 min',
  publishDate: '2026-03-17',
  lastModified: '2026-03-17',
  sections: [
      ...
      subsections: [
        ...
        },
        {
          ...
          content: `
            ...
            <p><strong>Over 6 weken:</strong> het verschil is klein. Slow carb levert gemiddeld 4-8 kilo op, keto 5-9 kilo. Het verschil zit hem niet in de kilo's maar in wat er daarna gebeurt.</p>
          `,
        },
        {
    ...
    },
    {
      ...
      content: `
        ...
        <p>Keto kan ook beter passen als je medische redenen hebt — bij epilepsie wordt keto soms therapeutisch ingezet, en sommige mensen met type 2 diabetes ervaren voordelen. Raadpleeg altijd een arts.</p>
      `,
    },
    {
      ...
      content: `
        ...
        <table>
          ...
          <tbody>
            ...
            <tr><td><strong>Resultaat 6 weken</strong></td><td>4-8 kg</td><td>5-9 kg</td></tr>
