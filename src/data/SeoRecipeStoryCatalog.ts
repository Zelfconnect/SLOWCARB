...
export class SeoRecipeStoryCatalog {
  private static readonly stories: Readonly<Record<string, readonly string[]>> = {
    ...
    'ferriss-klassieker': [
      'Dit is het ontbijt dat het slow carb verhaal voor veel mensen begonnen is: eieren, eiwit en zwarte bonen in één bord. Het klinkt recht-toe-recht-aan, maar het werkt omdat het simpel vol te houden is, zonder ingewikkelde lijstjes vóór acht uur ’s ochtends.',
