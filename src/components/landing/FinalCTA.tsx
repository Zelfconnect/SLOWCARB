    ...
    <section className="final-cta-section relative overflow-hidden bg-surface-dark py-28 text-center md:py-40">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6">
        <div className="final-cta-panel rounded-[2rem] border border-white/10 bg-white/8 px-6 py-10 shadow-[0_30px_60px_rgba(10,10,10,0.28)] backdrop-blur md:px-10 md:py-12">
          ...
          <h2 className="landing-balance mt-6 text-5xl font-heading font-bold uppercase leading-[1.05] tracking-tighter text-inverse-strong md:text-[60px]">
            5 regels. 6 weken. &euro;47.
          </h2>
          <div className="mx-auto mb-10 mt-8 max-w-2xl space-y-6">
            <p className="landing-pretty editorial-body text-inverse-body">
              Dit is alles wat je nodig hebt om te beginnen. De regels ken je al. De app doet de rest.
            </p>
          </div>
          <div className="mb-6 flex flex-wrap items-center justify-center gap-3 text-inverse-muted">
          ...
          <div className="mt-6 flex flex-col items-center justify-center gap-2 text-xs font-medium text-inverse-muted md:flex-row md:gap-4 md:text-sm">
