...
const includes = [
  ...
  { title: 'Altijd toegang', body: 'Nieuwe recepten en verbeteringen, zonder abonnement of maandelijkse verrassing.', meta: 'Eenmalig betalen' },
];
  ...
  return (
    <section id="pricing" className="pricing-story-section relative overflow-hidden">
      ...
      <div className="pricing-intro-shell">
        <div className="max-w-5xl mx-auto px-5 sm:px-6 relative z-10">
          <div className="max-w-3xl mx-auto text-center scroll-animate">
            <span className="inline-flex items-center rounded-full bg-sage-50/[.92] px-4 py-2 editorial-kicker text-ink-strong shadow-[0_12px_24px_rgba(26,54,54,0.08)] ring-1 ring-sage-200/90 backdrop-blur">
              Eenmalig. Geen abonnement.
            </span>
            <h2 className="mt-6 text-[2.35rem] leading-[1.02] sm:text-5xl md:text-[3.35rem] font-bold font-display text-ink-strong tracking-tight">
              Alles wat je nodig hebt om de 5 regels vol te houden.
            </h2>
            <p className="card-body mt-4 text-ink-body max-w-2xl mx-auto">
              Rustige, duidelijke tools om snel te starten. Voor minder dan wat de meeste mensen kwijt zijn aan een paar sessies of een jaarabonnement.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="pricing-compare-band">
        <div className="max-w-5xl mx-auto px-5 sm:px-6 relative z-10">
          <div className="pricing-compare-shell scroll-animate">
            <div className="px-5 pt-6 pb-4 md:px-8 md:pt-8 md:pb-5">
              ...
              <div className="mt-3 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
                <h3 className="font-sans text-[1.95rem] font-bold leading-[1.05] tracking-tight text-ink-strong md:text-[2.25rem]">Wat kost afvallen normaal?</h3>
                <p className="max-w-md support-copy text-ink-body">SlowCarb Protocol houdt het simpel: één betaling, altijd toegang, geen maandelijkse verrassing.</p>
              </div>
            </div>

            {competitors.map((c) => (
              <div key={c.name} className="pricing-compare-row">
                <div>
                  <p className="text-lg font-medium text-ink-strong">{c.name}</p>
                  <p className="mt-1 support-copy text-ink-muted">{c.note}</p>
                </div>
            ...
            <div className="pricing-compare-highlight">
              <div>
                ...
                <p className="mt-2 text-xl md:text-2xl font-sans font-bold tracking-tight text-ink-strong">Eén betaling. Daarna gewoon gebruiken.</p>
              </div>
              <div className="text-left md:text-right">
                <p className="editorial-kicker text-ink-muted">Vandaag</p>
                <p className="mt-2 text-4xl md:text-5xl font-bold font-sans tracking-tight text-ink-strong">&euro;47</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="pricing-offer-shell">
        <div className="max-w-5xl mx-auto px-5 sm:px-6 relative z-10">
          <div className="pricing-layout scroll-animate" id="offer-headline">
            <div>
              <p className="editorial-kicker text-sage-700">Wat je krijgt</p>
              <h3 className="mt-4 font-sans text-[1.95rem] font-bold leading-[1.05] tracking-tight text-ink-strong md:text-[2.35rem]">Alles wat je nodig hebt om te starten.</h3>
              <p className="mt-4 card-body text-ink-body max-w-2xl">AmmoCheck, recepten, 84 dagen uitleg en een rustige startweek. Zodat je niet opnieuw hoeft uit te zoeken waar je begint.</p>

              <div className="pricing-includes mt-6 md:mt-8">
                {includes.map((item, i) => (
                  <article key={i} className="pricing-include-item">
                    <div className="pricing-include-index">{String(i + 1).padStart(2, '0')}</div>
            ...
            <aside className="pricing-card">
              <p className="editorial-kicker text-sage-700">Altijd toegang</p>
              ...
              <button type="button" className="pricing-cta-button" onClick={onCheckout}>
              ...
              <p className="mt-4 support-copy text-ink-body">Je krijgt direct toegang tot het volledige protocol. Past het niet, dan krijg je binnen 30 dagen je geld terug.</p>
            </aside>
          </div>
        </div>
      </div>
