      ...
      <div className="relative z-10 mx-auto max-w-6xl px-5 sm:px-6 md:px-10">
        <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,1.08fr)_minmax(18rem,0.92fr)] lg:gap-16">
          <div className="min-w-0">
            ...
            <h2 className="landing-balance mt-4 text-5xl font-display font-medium leading-[1.02] tracking-tight text-ink-strong md:text-7xl lg:text-[5.5rem]">
              Herkenbaar?
            </h2>
            <div className="mt-10 max-w-3xl space-y-7 md:space-y-8">
              <p className="landing-pretty editorial-body text-ink-body">
              ...
              <p className="landing-pretty editorial-body border-t border-warm-300 pt-8 text-ink-strong">
                SlowCarb is geen dieet. Het is een simpel systeem met 5 regels.
              </p>
            </div>
          </div>

          <aside className="recognition-note-card motion-surface rounded-[2rem] border border-warm-200/80 bg-white/88 p-6 shadow-[0_24px_44px_rgba(28,25,23,0.08)] backdrop-blur md:p-7">
            ...
            <div className="mt-6 space-y-4">
              <div className="recognition-note-item">
                ...
                <div>
                  <p className="landing-balance font-sans text-lg font-bold tracking-tight text-ink-strong">Te veel regels</p>
                  <p className="landing-pretty support-copy mt-1 text-ink-body">Hoe meer uitzonderingen, hoe sneller je afhaakt.</p>
                </div>
              </div>
              <div className="recognition-note-item">
                <span className="recognition-note-index">02</span>
                <div>
                  <p className="landing-balance font-sans text-lg font-bold tracking-tight text-ink-strong">Te veel keuzes</p>
                  <p className="landing-pretty support-copy mt-1 text-ink-body">Iedere maaltijd wordt een onderhandeling met jezelf.</p>
                </div>
              </div>
              <div className="recognition-note-item">
                <span className="recognition-note-index">03</span>
                <div>
                  <p className="landing-balance font-sans text-lg font-bold tracking-tight text-ink-strong">Te veel denkwerk</p>
                  <p className="landing-pretty support-copy mt-1 text-ink-body">Wilskracht raakt op. Structuur niet.</p>
                </div>
              </div>
            </div>
            <p className="landing-pretty support-copy mt-6 border-t border-warm-200/80 pt-5 text-ink-muted">
