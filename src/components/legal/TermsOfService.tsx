export function TermsOfService() {
  return (
    <main className="mx-auto min-h-screen w-full max-w-3xl bg-cream px-5 py-10 text-stone-800 font-['Source_Sans_3']">
      <div className="space-y-8">
        ...
        <header className="space-y-3">
          <h1 className="font-['Fraunces'] text-3xl font-black">Algemene voorwaarden</h1>
        ...
        <section className="space-y-3">
          <h2 className="font-['Fraunces'] text-xl font-black text-sage-800">Wat is SlowCarb?</h2>
        ...
        <section className="space-y-3">
          <h2 className="font-['Fraunces'] text-xl font-black text-sage-800">Eenmalige betaling</h2>
          <p className="text-sm leading-relaxed text-stone-700">
        ...
        <section className="space-y-3">
          <h2 className="font-['Fraunces'] text-xl font-black text-sage-800">Intellectueel eigendom</h2>
          <p className="text-sm leading-relaxed text-stone-700">
        ...
        <section className="space-y-3">
          <h2 className="font-['Fraunces'] text-xl font-black text-sage-800">Aansprakelijkheid</h2>
          <p className="text-sm leading-relaxed text-stone-700">
        ...
        <section className="space-y-3">
          <h2 className="font-['Fraunces'] text-xl font-black text-sage-800">Beeindiging</h2>
          <p className="text-sm leading-relaxed text-stone-700">
