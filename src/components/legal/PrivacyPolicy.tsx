    ...
    <main className="mx-auto min-h-screen w-full max-w-3xl bg-cream px-5 py-10 text-stone-800 font-['Source_Sans_3']">
      <div className="space-y-8">
        ...
        <header className="space-y-3">
          <h1 className="font-['Fraunces'] text-3xl font-black">Privacybeleid</h1>
        ...
        <section className="space-y-3">
          <h2 className="font-['Fraunces'] text-xl font-black text-sage-800">Welke data verzamelen we?</h2>
        ...
        <section className="space-y-3">
          <h2 className="font-['Fraunces'] text-xl font-black text-sage-800">Betalingen via Stripe</h2>
          <p className="text-sm leading-relaxed text-stone-700">
        ...
        <section className="space-y-3">
          <h2 className="font-['Fraunces'] text-xl font-black text-sage-800">Wat we niet doen</h2>
          <ul className="list-disc space-y-1 pl-5 text-sm leading-relaxed text-stone-700">
        ...
        <section className="space-y-3">
          <h2 className="font-['Fraunces'] text-xl font-black text-sage-800">Contact</h2>
          <p className="text-sm leading-relaxed text-stone-700">
