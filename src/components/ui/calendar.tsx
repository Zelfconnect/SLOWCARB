  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekday: cn(
          "w-8 shrink-0 text-center text-muted-foreground font-normal text-[0.8rem] select-none",
          defaultClassNames.weekday
        ),
        week: cn("flex mt-1 gap-0", defaultClassNames.week),
        ...
        day: cn(
          "relative flex h-8 w-8 shrink-0 items-center justify-center p-0 text-center [&:last-child[data-selected=true]_button]:rounded-r-md group/day select-none",
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-lg text-sm leading-none font-normal",
